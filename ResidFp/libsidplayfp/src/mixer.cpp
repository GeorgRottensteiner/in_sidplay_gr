...
void Mixer::updateParams()
{
    ...
    {
    case 1:
        m_mix[0] = m_stereo ? &Mixer::stereo_OneChip : (mixer_func_t)&Mixer::mono<1>;
        if (m_stereo) m_mix[1] = &Mixer::stereo_OneChip;
        break;
    case 2:
        m_mix[0] = m_stereo ? &Mixer::stereo_ch1_TwoChips : (mixer_func_t)&Mixer::mono<2>;
        if (m_stereo) m_mix[1] = &Mixer::stereo_ch2_TwoChips;
        break;
    case 3:
        m_mix[0] = m_stereo ? &Mixer::stereo_ch1_ThreeChips : (mixer_func_t)&Mixer::mono<3>;
